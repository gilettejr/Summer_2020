...
def plotHess(mag, color, levels='None', xlims=[-1,4.5], ylims=[21,11], colormap=cm.plasma, cbarr='None', cbarrtitle='', xlab='$J_0$-$K_0$', ylab='$K_0$', saveas='HessCMD.png'):
    """
    ...
    plt.plot(color,mag,linestyle='none',marker ='.',ms=1,color='black',zorder=1)
    ylabel(ylab)
    xlabel(xlab)
