...
class bookkeeping:
    ...
    def update_from_scratch(self, galaxy_type='des'):
        ...
        for galaxy_object in all_galaxy_datasets:
            ...
            try:
                ...
                galaxy_object.save_to_parquet(
                    'processed_data/cls_cut_data/' + galaxy_object.galaxy)
            ...
            try:
                ...
                galaxy_object.save_to_parquet(
                    'processed_data/fore_cut_data/' + galaxy_object.galaxy)
            except:
            ...
            try:
                galaxy_object.save_to_parquet(
                    'processed_data/agb_data/' + galaxy_object.galaxy)
            except:
        ...
        for galaxy_object in all_galaxy_datasets:
            try:
                galaxy_object.save_to_csv(
                    'crossmatching/ukirt_pre/' + galaxy_object.galaxy)
            except:
        ...
        for galaxy_object in all_galaxy_datasets:
            galaxy_object.gaia_remove(
                'crossmatching/gaia/' + galaxy_object.galaxy)
            try:
                galaxy_object.save_to_parquet(
                    'processed_data/agb_crossed_data/' + galaxy_object.galaxy)
            except:
            ...
            galaxy_object.cm_save_to_parquet(
                'processed_data/m_agb_data/' + galaxy_object.galaxy, 'processed_data/c_agb_data/' + galaxy_object.galaxy)
    ...
    def make_cls_crossed_data(self, galaxy_type='des'):
        ...
        for galaxy_object in all_galaxy_datasets:
            try:
                galaxy_object.save_to_csv(
                    'crossmatching/ukirt_pre/cls_cut' + galaxy_object.galaxy)
            except:
        ...
        for galaxy_object in all_galaxy_datasets:
            galaxy_object.gaia_remove(
                'crossmatching/gaia/cls_cut' + galaxy_object.galaxy)
            try:
                galaxy_object.save_to_parquet(
                    'processed_data/cls_crossed_data/' + galaxy_object.galaxy)
            except:
