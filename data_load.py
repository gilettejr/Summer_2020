...
class data_loader:
    ...
    def __init__(self, galaxy, CLS=True, cls_bands='norm', mag=True, ext=True, path_to_file='initial_data/'):
        ...
        excolumnames = ['rah', 'ram', 'ras', 'dd', 'dm', 'ds', 'unknown', 'xj', 'yj', 'jmag', 'jerr', 'jcis',
                        'xh', 'yh', 'hmag', 'herr', 'hcis', 'xk', 'yk', 'kmag', 'kerr', 'kcis', 'u1', 'u2', 'u3', 'u4']
        columnames = ['rah', 'ram', 'ras', 'dd', 'dm', 'ds', 'unknown', 'xj', 'yj', 'jmag',
                      'jerr', 'jcis', 'xh', 'yh', 'hmag', 'herr', 'hcis', 'xk', 'yk', 'kmag', 'kerr', 'kcis']

        # galaxy list for reading in the correct file

        galaxies = ['ngc147', 'ngc185', 'ngc205', 'm32', 'm31', 'and1', 'and2', 'and3', 'and6',
                    'and7', 'and10', 'and14', 'and15', 'and16', 'and17', 'and18', 'and19', 'and20']
        ...
        if galaxy == 'm31':
            ...
            galaxy_data = pd.read_csv(
                path_to_file + file, sep="\s+", names=excolumnames)
        ...
        if CLS == True:
            ...
            galaxy_data = startup_processor.galaxy_data
            print(str(len(galaxy_data)) + ' is the starting catalogue length')
    ...
    def do_forecut(self):
        ...
        forecuts = [0.992, 0.964, 1.00, 0.92, 1.002, 1.002, 1.002, 1.002, 1.002,
        ...
        print('Foreground cut reduced data by ' + str(int(decrease)) +
              '%, ' + str(len(data)) + ' sources retained')
    ...
    def do_trgbcut(self):
        ...
        trgbcuts = [18.137, 17.862, 17.930, 17.8, 17.8, 18.27, 18.05, 18.43,
                    18.41, 18.27, 18.27, 18.77, 18.38, 17.92, 18.52, 19.65, 18.75, 18.66]
        ...
        print('RGB cut reduced data by ' + str(int(decrease)) +
              '%, ' + str(len(data)) + ' sources retained')
    ...
    def do_CM_cut(self):
        ...
        hkcuts = [0.337, 0.323, 0.407, 0.477, 0,
