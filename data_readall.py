...
class data_readall:
    ...
    def __init__(self, stage='agb', arcmin_radius=False):
        ...
        if stage == 'agb':
            ...
            self.n147_crossed = data_reader(
                stage='agb_crossed', galaxy='ngc147')

        else:

            self.n147_crossed = data_reader(
                stage='cls_crossed', galaxy='ngc147')
    ...
    def plot_kj_cmds(self, marker='.', markersize=3, color='black'):
        ...
        sns.scatterplot(n147.jmag-n147.kmag, n147.kmag, marker=marker, s=markersize,
                        linewidth=0, color='black', ax=axs[0, 0], label='NGC 147')
        sns.scatterplot(n185.jmag-n185.kmag, n185.kmag, marker=marker, s=markersize,
                        linewidth=0, color='black', ax=axs[0, 1], label='NGC 185')
        sns.scatterplot(n205.jmag-n205.kmag, n205.kmag, marker=marker, s=markersize,
                        linewidth=0, color='black', ax=axs[1, 0], label='NGC 205')
        sns.scatterplot(m32.jmag-m32.kmag, m32.kmag, marker=marker, s=markersize,
                        linewidth=0, color='black', ax=axs[1, 1], label='M32')
    ...
    def plot_kj_cmd_gaia_removal(self):
        ...
        sns.scatterplot(n147_uncleaned.jmag-n147_uncleaned.kmag, n147_uncleaned.kmag,
                        ax=axes[0], linewidth=0, s=5, marker='.', color='black', label='Uncleaned')
        sns.scatterplot(n147_cleaned.jmag-n147_cleaned.kmag, n147_cleaned.kmag,
                        ax=axes[1], marker='.', linewidth=0, s=5, color='black', label='Cleaned')
    ...
    def plot_gaia_removal(self):
        ...
        sns.scatterplot(n147_cleaned.jmag-n147_cleaned.kmag, n147_cleaned.kmag,
                        s=10, marker='.', linewidth=0, color='black', ax=axes[0])
        sns.scatterplot(n147_fore.jmag-n147_fore.kmag, n147_fore.kmag,
                        s=50, marker='o', color='red', linewidth=0, ax=axes[0])

        sns.scatterplot(n147_cleaned.jmag-n147_cleaned.hmag, n147_cleaned.hmag -
                        n147_cleaned.kmag, s=10, marker='.', linewidth=0, color='black', ax=axes[1])
        sns.scatterplot(n147_fore.jmag-n147_fore.hmag, n147_fore.hmag -
                        n147_fore.kmag, s=50, marker='o', color='red', linewidth=0, ax=axes[1])
    ...
    def plot_kj_cmd_hess(self):
        ...
        subhess.plot_kj_cmd(n147.jmag-n147.kmag, n147.kmag,
                            ax=axs[0, 0], label='NGC 147')
        subhess.plot_kj_cmd(n185.jmag-n185.kmag, n185.kmag,
                            ax=axs[0, 1], label='NGC 185')
    ...
    def plot_cc_hess(self):
        ...
        subhess.plot_kj_cmd(n147.jmag-n147.hmag, n147.hmag -
                            n147.kmag, ax=axs[0, 0], label='NGC 147')
        subhess.plot_kj_cmd(n185.jmag-n185.hmag, n185.hmag -
                            n185.kmag, ax=axs[0, 1], label='NGC 185')
        subhess.plot_kj_cmd(n205.jmag-n205.hmag, n205.hmag -
                            n205.kmag, ax=axs[1, 0], label='NGC 205')
        subhess.plot_kj_cmd(m32.jmag-m32.hmag, m32.hmag -
                            m32.kmag, ax=axs[1, 1], label='M32')
